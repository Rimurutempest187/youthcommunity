...
from utils import BOT_TOKEN, require_bot_token
import handlers
...
# Create and set an event loop so ApplicationBuilder can create asyncio.Queue etc.
# This avoids "There is no current event loop" errors in some environments.
...
if __name__ == "__main__":
    print("Bot starting...")
    try:
        # run_polling will run the event loop; since we set a loop above, this will work reliably
        app.run_polling()
